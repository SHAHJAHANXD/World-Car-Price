                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">{{ $Country->rate }}</td>
                                        <td class="text-center">{{ $Country->symbol }}</td>

                                        <td class="text-center">{{ $Country->slug }}</td>
                                        <td class="text-center">
                                            <a class="btn btn-primary" onclick="return confirm('Are you sure? You want to edit this record?')" href="/administrator/edit-countries/{{ $Country->id }}">Edit</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
