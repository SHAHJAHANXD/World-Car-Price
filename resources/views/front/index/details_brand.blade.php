...
@section('title')
New Upcoming {{ $category }} Price & Specification - World Car Price
@endsection
@section('description')
Find upcoming {{ $category }} models' prices in 2023, their pictures, and specifications - Compare cars, read new car reviews and post ratings at Car World Price.
@endsection
@section('content')
    <main class="main">
        <div class="container">
                    ...
                    <div class="col-lg-7">
                        <div class="row">
                            <div class="col-12">
                                ...
                                New {{ $category }} 2022, New Car Prices And Specs
                                </h1>
                            </div>
                        </div>
                        <div class="row">
                                    ...
                                    <div class="row">
                                        @foreach ($brand as $brand)
                                            <div class="col-6"
                                                ...
                                                <a href="/{{ $category }}/{{ $brand->Brand_name }}"
                                                    style="color: black;">
